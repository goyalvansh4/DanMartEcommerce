    ...
    <footer class="bg-gray-900 p-10 font-[sans-serif] tracking-wide">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div class="lg:flex lg:items-center">
          <a href="javascript:void(0)" className='text-white text-2xl font-semibold'>
          VisionOverseas
          </a>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-4">
            <li>
              <a href="javascript:void(0)" class="text-gray-300 hover:text-white text-sm">Email:visionoverseas37@gmail.com</a>
            </li>
            <li>
              <a href="javascript:void(0)" class="text-gray-300 hover:text-white text-sm">Phone: +91 8279792033</a>
            </li>
          </ul>
        </div>
      ...
      <p class='text-gray-300 text-sm mt-10'>© {new Date().getFullYear()}<a href='https://readymadeui.com/' target='_blank'
        class="hover:underline mx-1">made with ❤️ by FEBTECH IT Solutions.</a>All Rights Reserved.
      </p>
    </footer>
  )
}
