...
const NewArrival = () => {
  ...
  return (
    <div className="my-5 font-sans py-5 w-11/12 mx-auto ">
      <h2 className="text-4xl text-center font-extrabold text-gray-800 mb-4">New Arrivals</h2>
      <p className="text-xl text-center font-semibold text-gray-700 mb-12">It's a gateway to another era</p>
