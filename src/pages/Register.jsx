        ...
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            ...
            <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
              Welcome to visionOverseas 🌏
            </h2>
            <p className="mt-4 leading-relaxed text-white/90">
              Discover new horizons with our platform. Join us and explore the world of opportunities.
            </p>
          </div>
        </section>
        <div className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              <a
                className="inline-flex items-center justify-center rounded-full bg-white text-blue-600 p-4 dark:bg-gray-900"
                href="#"
              >
                <span className="sr-only">Home</span>
                <svg
              ...
              <h1 className="mt-6 text-2xl font-bold text-gray-700 sm:text-3xl md:text-4xl dark:text-white">
                Welcome to visionOverseas 🌏
              </h1>
